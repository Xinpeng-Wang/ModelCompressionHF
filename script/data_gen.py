...
def create_training_file(docs, vocab_list, args, epoch_num, split, bi_text=True):
    epoch_filename = args.output_dir / "epoch_{}_{}.json".format(epoch_num, split)
    num_instances = 0
    with epoch_filename.open('w') as epoch_file:
        for doc_idx in trange(len(docs), desc="Document"):
            ...
            for instance in doc_instances:
                ...
                num_instances += 1
    metrics_filename = args.output_dir / "epoch_{}_metrics_{}.json".format(epoch_num, split)
...
def generate(args, train_corpus, split):
    ...
    with DocumentDatabase(reduce_memory=args.reduce_memory) as docs:
        ...
        for epoch in trange(args.epochs_to_generate, desc="Epoch"):
            ...
            epoch_file, metric_file = create_training_file(docs, vocab_list, args, epoch, split,bi_text=bi_text)
...
def main():
    ...
    writer_workers.starmap(generate, arguments)
